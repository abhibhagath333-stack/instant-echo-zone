...
import { Package, Plus, Pencil, Trash2, ShoppingBag, TrendingUp, Box } from 'lucide-react';
    ...
    <div className="container py-8 space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage your product listings & inventory</p>
        </div>
          ...
          <DialogContent>
            ...
            <div className="space-y-4 mt-2">
              <div className="space-y-1.5">
                ...
                <Input value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="e.g. Organic Neem Oil" />
              </div>
              <div className="space-y-1.5">
                <Label>Description</Label>
                <Textarea value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })} placeholder="Product details..." rows={3} />
              </div>
              ...
              <Button className="w-full" onClick={handleSave} disabled={!form.name || !form.price}>
            ...
            <Card key={p.id} className="shadow-soft">
              {p.image_url && (
                <div className="h-40 overflow-hidden rounded-t-lg bg-muted">
                  <img src={p.image_url} alt={p.name} className="h-full w-full object-cover" onError={(e) => { (e.target as HTMLImageElement).src = '/placeholder.svg'; }} />
                </div>
              )}
